                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 table-sm">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $query = DB::query("SELECT * FROM officers WHERE  status='Active' ORDER BY  officer_id DESC");
                                                    if($query){
                                                        $i=1;
                                                        foreach($query as $result){
                                                            ...
                                                            $officerId = $result['officer_id'];
                                                             $query2 = DB::queryFirstRow("SELECT * FROM postings WHERE officer_id='$officerId' AND (status='Active' OR status='Pass Out') LIMIT 1");
                                                             if($query2){
                                                            ...
                                                            $query3 = DB::query("SELECT count(officer_id) As totalPosting FROM postings WHERE officer_id='$officerId' AND (status='Deleted' OR status='Pending')");
                                                            if($query3){
                                                ...
                                                ?>
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td>
                                                                        <button type="button" data-officerId="<?php echo $result['officer_id']; ?>" class="btn btn-xs btn-outline-success waves-effect waves-light officerId mr-1" data-bs-toggle="modal" data-bs-target="#posting-detail-modal"><i class="fas fa fa-eye"></i></i></button>
                                                                        &nbsp; &nbsp;
                                                                        <button type="button" data-officerId="<?php echo $result['officer_id']; ?>" class="btn btn-xs btn-outline-primary waves-effect waves-light officerId ml-1" data-bs-toggle="modal" data-bs-target="#officer-detail-modal"><i class="fas fa fa-edit"></i></i></button>
