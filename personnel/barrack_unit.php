                                                ...
                                                ?>
                                                            ...
                                                            <tr class="">
                                                               <td><?php echo  $result['unit_code']; ?></td>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-outine-success waves-effect waves-light barrackImageId" data-barrackUnitImageId=<?php echo $result['barrack_unit_id']; ?> 
                                                                    data-bs-toggle="modal" data-bs-target="#barrack-unit-images-modal"><i class="fas fa-image"></i></button>
                                                                 </td>
                                                            </tr>
                                                <?php
                                                        }
